...
export const SHORTCUTS = {
  ...
  JUMP_FORWARD: 'l',
  PAUSE: 'k',
  STEP_FRAME_BACKWARD: 'ArrowLeft',
  STEP_FRAME_FORWARD: 'ArrowRight',
  NUDGE_CLIPS_BACKWARD: 'Alt+ArrowLeft',
  NUDGE_CLIPS_FORWARD: 'Alt+ArrowRight',
  NUDGE_EDGE_BACKWARD: 'Shift+Alt+ArrowLeft',
  NUDGE_EDGE_FORWARD: 'Shift+Alt+ArrowRight',
  TOGGLE_SNAPPING: 'n',
  SPLIT: 's',
  DELETE: 'Delete',
